...
public class PokemonHoverbox : MonoBehaviour, IPointerExitHandler {
    private static PokemonHoverbox instance = null;
    #region Variables
    // Needs to be a Singleton and not a static class because its a MonoBehaviour
    public static PokemonHoverbox Instance {
        get {
            if (instance == null) instance = new GameObject("").AddComponent<PokemonHoverbox>();
            return instance;
        }
        set { Instance = value; }
    }
