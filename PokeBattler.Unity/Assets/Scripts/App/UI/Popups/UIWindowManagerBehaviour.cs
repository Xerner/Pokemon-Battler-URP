...
{
    [AddComponentMenu("Poke Battler/UI Window Manager")]
    [RequireComponent(typeof(UIModal))]
    public class UIWindowManagerBehaviour : MonoBehaviour
    {
        public static UIWindowManagerBehaviour Instance { get; private set; }
