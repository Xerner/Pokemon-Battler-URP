...
public class ShopCard : MonoBehaviour
{
    ...
    public void SetPokemon(Pokemon pokemon)
    {
        ...
        type1.sprite = AssetManager.PokemonTypesSprites[pokemon.type1.ToString()].MiniSprite;
        type2.sprite = AssetManager.PokemonTypesSprites[pokemon.type2.ToString()].MiniSprite;
        type1.SetNativeSize();
        type2.SetNativeSize();
