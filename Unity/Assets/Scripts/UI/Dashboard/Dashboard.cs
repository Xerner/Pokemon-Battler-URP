...
namespace Poke.View
{
    public class Dashboard : MonoBehaviour
    {
        ...
        {
            if (!HostBehaviour.Instance.GameSettings.FreeExperience)
            {
        ...
        {
            if (!HostBehaviour.Instance.GameSettings.FreeRefreshShop)
            {
            ...
            if (this.pokemons != null) HostBehaviour.Instance.Host.Game.PokemonPool.Refund(this.pokemons);
            Pokemon[] pokemons = HostBehaviour.Instance.Host.Game.PokemonPool.Withdraw5();
